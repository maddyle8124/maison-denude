...
2. Have a booking system live and tested end-to-end.
3. Carry cornerstone SEO content earning organic traffic from day one.
4. Convert visitors into booking inquiries.
...
- 4/4 tracking tools live and collecting data (GTM, GA4, GSC, Google Business Profile).
- 3/3 website pages live on Cloudflare Pages (`/`, `/blog`, `/booking`).
- Booking form → email flow functional (test submission confirmed).
- All Maison-provided blog content published + structured for target keywords.
- Baseline keyword rankings documented for all 7 target keywords.
- Lighthouse performance > 90 (mobile).
- Digital Marketing Playbook delivered for 3 confirmed markets (Vietnamese).
- Handover docs delivered (Vietnamese).
