...
The Digital Marketing Playbook for **3 target export markets** is a named Phase-1 deliverable. The market-selection work is led by Maddy. This file stays thin and points to where the real research lives until markets lock.
...
- ⭐ **DECK CHÍNH (present) → [`deck-hien-dien-so-maison.html`](./deck-hien-dien-so-maison.html)** ← deck hợp nhất, gọn, kể chuyện: pattern keyword/traffic/geo $2000+ · cầu tìm kiếm thật · case study Công Trí/Phan Huy · playbook 8 nước đi · adjacency (KHÔNG có đồng hồ/BĐS/khách sạn) · phương pháp. **Đây là bản để trình bày** — 2 deck dưới là bản chi tiết/backup.
- **Đào sâu Công Trí & Phan Huy (chi tiết) → [`dao-sau-congtri-phanhuy.html`](./dao-sau-congtri-phanhuy.html)** ← insight chi tiết: trust-subpages + subpage % + RTW-vs-bespoke + mass-vs-designer geo + multi-country keyword/intent + Pinterest. Raw: `data_logs/deep-dive-designers_2026-07.json`.
- **Playbook hiện diện số (chi tiết) → [`playbook-hien-dien-so.html`](./playbook-hien-dien-so.html)** ← action chi tiết: country priority · channel decision tree · sitemap (w/ Matthew) · keyword by intent · sequencing + owner/priority/confidence.
...
- [ ] Per-market file: scoring, SWOT, BCG position, entry tactic, complexity.
- [ ] Channel plan per market.
- [ ] KOL criteria (OQ-006) once Maison provides them.
- [ ] Playbook deliverable structure (Vietnamese — client-facing).
