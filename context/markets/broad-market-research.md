# Maison Dénudé — Nghiên Cứu Thị Trường Tổng Quát (Broad Research, Đa Dòng Sản Phẩm)

_Người thực hiện: Maddy (research lead). Ngày: 2026-06-21. Ngôn ngữ: tiếng Việt (deliverable nội bộ → đầu vào cho buổi Progress Presentation)._
...
**Phát hiện cấu trúc lớn nhất — có HAI hệ cầu tách biệt, gần như không chồng lấn:**

1. **Cầu inbound (khách đến VN may tại chỗ)** — *lớn, đa ngôn ngữ, nhưng gần như vô hình* với dữ liệu web tiếng Anh (vì nó sống trên RedNote/Ctrip của TQ, hcm-cityguide/note.com của Nhật, blog du lịch + TripAdvisor). Đây là bằng chứng ủng hộ luận điểm "bespoke chỉ nên bán cho người có ý định đến VN".
...
## 1. Bản đồ dòng sản phẩm & định vị Maison

| Dòng | Vai trò | Cầu search | Chế độ bán phù hợp |
|------|---------|------------|--------------------|
...
**Ranh giới thương hiệu của chị Chi (LUẬT — mọi đề xuất phải tuân):** ❌ "high end" · ❌ "tailor / may đo" (Maison là **nhà thiết kế/atelier**) · ❌ "mass / cheap deal / Vietnam shopping haul". ✅ premium/upscale · bespoke · artisanal · heritage · hand-craft · editorial. _Nguồn: [founder-signals.md](../client-context/founder-signals.md)._

---

## 2. Bản đồ đối thủ theo dòng (de-biased)

**Bảng điểm đối thủ** (traffic = SimilarWeb ước lượng, TB/tháng T6/25–T5/26; geo = top quốc gia khách):

| Đối thủ | Dòng | Bespoke / RTW | Ship? | Acquisition | Traffic |
|---------|------|---------------|-------|-------------|---------|
| **eastmeetsdress.com** | cheongsam, **áo dài**, bridal, prom | Bespoke-by-measure **+ RTW "Ships Now"** | Quốc tế (khách chịu thuế ~tới 50%) | **Search 54%**, Direct 36% (US 61%) | **63K** (phẳng) |
| **LAHAVA .com** ⚠️ | **áo dài + evening gown + bridal** | Made-to-measure, đa tiền tệ | Quốc tế | **Direct 44%**, Search 35%, Social 13% | 7.5K **↑↑** (3.6→12.4K) |
| **bebetailor.com** | tailoring đa món (Hoi An) | Bespoke | Quốc tế | Search 47%, Direct 36% | 13K **↑↑** (8.7→26.6K) |
| **adongsilk.com** | đa món, bridal (Hoi An) | Bespoke 24–48h | **Có — 8 zone DHL** | Search-led, TripAdvisor | 18.4K ↑ |
| **yalycouture.com** | couture/tailor (Hoi An) | Bespoke | Có | Direct 43%, Search 40% | 12.8K (phẳng) |
| **duantailor.com** | **áo dài bespoke heritage** (Saigon) | Bespoke "giao toàn cầu" | **Có, worldwide** | Search (có site .eu) | 2.8K ↑ |
| **maydosaigon.com** | áo dài bespoke cho expat | Bespoke | Site EN nhưng **VN 98%** | Local/WOM | **0.8K** |
...
## 3. Cầu theo dòng sản phẩm × địa lý

| Dòng | 🇺🇸US | 🇦🇺AU | 🇻🇳 | 🇨🇳/🇹🇼 | 🇯🇵 | 🇰🇷 | Chế độ chạy | Đọc ra |
|------|------|------|-----|--------|-----|-----|-------------|--------|
...
## 4. Du lịch inbound & "họ thấy gì đầu tiên"

**"Con voi Hoi An" là thật.** Mọi bề mặt tiếng Anh (TripAdvisor, blog, guide hãng bay, Naver) đẩy intent "may đồ" về **Hoi An**, khung *rẻ + nhanh + souvenir* ("đồ trong vài giờ", "bằng ½–⅔ giá ở nhà"). Đây là **ngược chiều** định vị premium Saigon → là **gió ngược danh tiếng**, không phải gió thuận.

**SERP Saigon cũng toàn listicle** "top tiệm may áo dài" ("4 tiếng, từ 300k"). **Không có tiếng nói nhà thiết kế premium nào** giữ bề mặt first-touch → khoảng trống có thật, nhưng nghĩa là Maison phải **TẠO cầu cho một category khách chưa search**, không phải bắt cầu sẵn.

→ **Hệ quả chiến lược: KHÔNG đua từ khoá "tailoring".** Đua trên **occasion / image / experience** — nơi khung "Hoi An rẻ" không áp dụng: look áo dài/evening editorial, "nâng cấp" trào lưu chụp ảnh áo dài, tủ đồ dự tiệc cho mùa cưới điểm đến.

**Lượng khách 2025: ~21.2M (+20%).** Xếp hạng đáng chú ý:

| Thị trường | Khách 2025 | Xu hướng | Đặc điểm cho Maison |
|------------|-----------|----------|---------------------|
| 🇨🇳 Trung Quốc | ~5.3M (~25%) | **+41%** | Image-driven; reach qua **RedNote** (Google vô dụng); hành vi premium = **旅拍 photo-tour** |
| 🇰🇷 Hàn Quốc | ~4.3M | −5% | Khoá vào khung Đà Nẵng/Hoi An rẻ; trần thấp |
| 🇺🇸 Mỹ | ~849K | ↑ | Diaspora, ship-based (đã bị EMD phục vụ) |
| 🇯🇵 Nhật | ~814K | +14% | Trọng chất lượng nhưng trần chi tiêu thấp, neo Hoi An |
| 🇮🇳 Ấn Độ | ~746K | **+49%** (+70% đầu '26) | **Đám cưới điểm đến luxury** → góc occasion/evening |
| 🇦🇺 Úc | ~548K | **+54%** | **Intent bespoke tiếng Anh thật nhất**; reach được bằng SEO |
| 🌙 Gulf | nhỏ, gộp "halal" | hạ tầng | Lệch về Hà Nội; **hoãn** |

**Cảnh báo quan trọng (từ social listening + verify): khách Á (TQ/Nhật/Hàn) chủ yếu THUÊ + CHỤP ẢNH, giữ lại ảnh chứ không mua bespoke.** Cầu *trải nghiệm* lớn, nhưng *sẵn sàng trả cho món bespoke giữ lại* **CHƯA được chứng minh**. → Góc Maison ở đây là **trải nghiệm photoshoot-thành-keepsake / editorial cao cấp**, không phải "khách sẽ mua áo dài bespoke $300+". Coi là **giả thuyết để test, không phải thị trường để đặt cược.** (Và TQ có rủi ro liên tưởng "đồ áo dài phố Nhật" nightlife — phải lái mạnh về tệp nữ 旅拍.)

---

## 5. Maison làm gì để giành share (theo dòng) + founder-fit check

**Khoảng trống để chiếm = "premium artisanal Saigon đa dòng, editorial, bespoke fit-tại-chỗ + capsule ship-by-design".** Chiếm trước khi LAHAVA chiếm.
...
**Founder-fit check:** mọi đề xuất trên giữ tông premium/artisanal/atelier/heritage, không "high end", không "tailor", không "mass". Hai vùng nhạy cảm cần giữ caveat: (a) khung photoshoot TQ phải là editorial/atelier, tránh trôi về "tour chụp ảnh rẻ"; (b) Gulf modest = quyết định của founder, KHÔNG phải đèn xanh (xem §6).
...
**Bằng chứng đánh đổi (cứng):** Aquamarine (Saigon, thủ công, made-to-measure) **chọn chỉ ship VN**; còn các brand RTW size-cố-định ship toàn cầu. La Lune "ship được" bằng cách **từ chối đổi-trả vì lệch size + khai "quà tặng" né thuế** — *lệch chuẩn* với một nhà premium hứa "vừa với bạn". → Capsule ship được là có thật nhưng **không miễn phí**: cần hệ size + fit-guide + hỗ trợ remote-fitting (chi phí + ops).
...
## 7. Xếp hạng thị trường pivot/test (đã sửa: cầu đã chứng minh ≠ lượng khách)

> **Hiệu chỉnh quan trọng từ verify:** xếp hạng theo *lượng khách* (TQ #1, Ấn #2) **không phải** xếp hạng theo *cầu đã chứng minh*. Tiền chắc chắn duy nhất = diaspora US/AU bridal; châu Á là *probe* lượng-cao-bằng-chứng-thấp.

| Hạng | Thị trường | Dòng dẫn | Kênh test | Trạng thái bằng chứng |
|------|-----------|----------|-----------|----------------------|
| **1** | 🇦🇺 Úc + 🇺🇸 Mỹ (diaspora) | Bridal áo dài "made in Saigon, fit khi đến" | **SEO EN + pre-trip + social diaspora** | ✅ **ĐÃ CHỨNG MINH** (cầu mua xuyên biên giới thật) |
| **2** | 🇨🇳 Trung Quốc | Occasion/áo dài + styled shoot (nâng cấp 旅拍) | **RedNote KOL** (không SEO) | ⚠️ Lượng lớn nhất; **mua premium CHƯA chứng minh**; rủi ro liên tưởng nightlife |
| **3** | 🇮🇳 Ấn Độ | Occasion/evening + couture | **B2B wedding planner + IG** | ⚠️ Tăng nhanh nhất; góc occasion là **suy luận**, chưa có nguồn nối tới áo dài |
| 4 | 🇯🇵 Nhật / 🇰🇷 Hàn | (niche / —) | JP boutique / Naver | Lượng cao, trần thấp, neo Hoi An → **giảm ưu tiên** |
| 5 | 🌙 Gulf | (defer) | — | Hạ tầng; lệch Hà Nội; là câu hỏi **sản phẩm ship**, không phải inbound |

---

## 8. Phương pháp, độ tin cậy & nguồn

**Bản đồ tin cậy (synthesizer phải giữ):**
- ✅ **ĐÃ CHỨNG MINH:** đánh đổi bespoke↔shippable (Aquamarine VN-only vs Fancì toàn cầu); cầu ship chỉ thật ở bridal áo dài US+AU; nhà thiết kế Saigon CÓ thể global mà không "mass/tailor" (Fancì); EMD cảnh báo thuế ~50%; in-person thắng cho áo dài; Saigon > Hoi An về chất lượng áo dài (khách đọc EN).
- ⚠️ **SUY ĐOÁN (gắn nhãn giả thuyết):** TQ/Ấn là *người mua* inbound premium (hành vi suy luận, mua chưa chứng minh); kinh tế 旅拍 áp cho Saigon (mượn số TQ nội địa); re-tier premium áo dài inbound; "fit giữa" như một *cầu*.
- ⛔ **KHÔNG được khẳng định như sự thật:** "Gulf không có cầu" (chỉ là *thiếu bằng chứng*, nói "chưa có bằng chứng", không nói "không có"); Aprilpoolday "ship 195+ nước" (mới xác nhận *bộ chọn tiền tệ*, chưa xác nhận ship); Hàn như kênh Maison (chưa đủ bằng chứng).

**Hạn chế dữ liệu:** SimilarWeb là ước lượng; site nhỏ (`maisondenude.com`, `dreamdressesbypmn`, `markandvy`, `lalune`) **không đo được** → không bịa. Keyword endpoint SW bị khoá → dùng Google Trends + web. Cầu CN/JP/KR vô hình trên site tiếng Anh (platform artifact). Reddit/TripAdvisor body bị chặn 403 → dùng snippet + blog first-person. SERP đo từ vantage Mỹ.

**Nguồn dữ liệu thô:** [`data_logs/`](./data_logs/) (SimilarWeb visits/geo/channels JSON). Đối chiếu: [01_seo_landscape.md](../../thieu/context/SEO/01_seo_landscape.md), [competitor.md](../../thieu/context/SEO/competitor.md) (VN-market), [BrandHub §2.2/§4.3/§6](../../MDenude_BrandHub_Internal.md).
