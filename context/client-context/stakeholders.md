...
- MD's internal SEO/content writer, added by Michelle on 6/6. Writes the brand's blog content.
- Advocates a **more artisanal / editorial** voice over commercial content; wants deeper brand-story pieces and richer dress-type research (halter, qipao, cheongsam, etc.). Relevant when coordinating who writes what (MD writes content; Thiệu structures & publishes).
...
- Pace is fast and informal (WhatsApp, frequent same-day calls). Team responsiveness is expected and valued.
- The client team can be a source of delay (their graphic designer resigned mid-project → visual design delayed; see `../decisions.md` MD-027). The contract buffer exists for exactly this.
