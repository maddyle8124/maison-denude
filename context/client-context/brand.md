...
## Earned media / social proof (Vietnam)
...
Full data: `/social proof maison denude.md`, `/maison_denude_posts.csv`.
...
Deeper internal strategy (upsell signals, expansion tactics, AI tooling, per-market tactical intel) lives in `/MDenude_BrandHub_Internal.md` — **internal only, never share with client.**
