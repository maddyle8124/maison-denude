...
export const aboutPage = {
  ...
  title: 'The Maison',
  paragraphs: [
    'Maison Dénudé is a bespoke fashion house in Saigon. The name means to strip down, to reveal — every piece begins by removing what is unnecessary, until only presence remains.',
  ...
  imageAlt:
    'Model in an embroidered coat from the Renaissance collection — Maison Dénudé editorial',
